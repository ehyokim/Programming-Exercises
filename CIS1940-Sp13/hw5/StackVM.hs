...
compile = reify . parseExp lit add mul
    where reify :: Maybe Program -> Maybe Program
          reify = id


testProgram :: Either String StackVal
testProgram = case testExp :: Maybe Program of
                Just exp -> stackVM exp
                _ -> Left "Execution of Test Program Failed."
